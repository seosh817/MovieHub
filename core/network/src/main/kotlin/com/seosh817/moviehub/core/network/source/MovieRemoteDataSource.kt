...
interface MovieRemoteDataSource {
    ...
    suspend fun fetchPopularMovies(page: Int, language: String?): ResultState<NetworkMoviesResponse>

    suspend fun fetchTopRatedMovies(page: Int, language: String?): ResultState<NetworkMoviesResponse>

    suspend fun fetchUpcomingMovies(page: Int, language: String?): ResultState<NetworkMoviesResponse>

    suspend fun fetchMovieDetail(movieId: Long, language: String?): ResultState<NetworkMovieDetail>
}
